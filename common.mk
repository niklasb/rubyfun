...
fuzzermain.$(OBJEXT): $(hdrdir)/ruby/ruby.h
fuzzermain.$(OBJEXT): $(top_srcdir)/include/ruby.h
fuzzermain.$(OBJEXT): {$(VPATH)}backward.h
fuzzermain.$(OBJEXT): {$(VPATH)}config.h
fuzzermain.$(OBJEXT): {$(VPATH)}defines.h
fuzzermain.$(OBJEXT): {$(VPATH)}intern.h
fuzzermain.$(OBJEXT): {$(VPATH)}fuzzermain.c
fuzzermain.$(OBJEXT): {$(VPATH)}missing.h
fuzzermain.$(OBJEXT): {$(VPATH)}node.h
fuzzermain.$(OBJEXT): {$(VPATH)}st.h
fuzzermain.$(OBJEXT): {$(VPATH)}subst.h
fuzzermain.$(OBJEXT): {$(VPATH)}vm_debug.h
